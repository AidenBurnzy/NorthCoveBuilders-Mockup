...
export default function GalleryPage() {
  return (
    <section className="section-shell !pt-40 md:!pt-[8.5rem]">
      <Reveal>
        <div className="mx-auto max-w-3xl rounded-2xl bg-surface p-8 text-center md:p-12">
          <p className="text-sm font-semibold uppercase tracking-[0.15em] text-brand">Gallery</p>
          <h1 className="mt-3 text-4xl text-brand md:text-5xl">Explore room-by-room inspiration on Houzz.</h1>
